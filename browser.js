...
var SpeedcontrolUtil = /** @class */ (function (_super) {
    ...
    SpeedcontrolUtil.prototype.startTimer = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nodecg.sendMessageToBundle('timerStart', sc)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.nodecg.sendMessageToBundle('timerStop', sc, { id: uuid })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SpeedcontrolUtil.prototype.resetTimer = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.nodecg.sendMessageToBundle('timerReset', sc)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SpeedcontrolUtil.prototype.startTwitchCommercial = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.nodecg.sendMessageToBundle('twitchStartCommercial', sc)];
            });
        });
    };
